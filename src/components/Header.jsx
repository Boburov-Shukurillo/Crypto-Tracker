...
const Header = ({ setMt, setModalD, searchCoin, setSearchCoin }) => {
  ...
  return (
    <header className="bg-darkenBlack backdrop-blur-md">
      <div className="containerb flex items-center relative justify-between h-20">
        <Link to="/">
          <img src={second} className="h-full w-44 max-md:w-32 max-sm:w-24" alt="logo" />
        </Link>

        {/* <div className="hidden max-950:block w-full h-96 top-0 left-0 fixed bg-darkenGray">
        ...
        <input
          ...
          className="w-1/3 max-md:w-1/2 bg-darkenBlack/5 order-1 border-darkenGray border-2 rounded-xl h-12 px-5 montserrat text-lg text-white"
